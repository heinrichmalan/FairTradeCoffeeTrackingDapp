...
contract SupplyChain {
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "Caller needs to be valid");
        _;
    }
    ...
    modifier paidEnough(uint256 _price) {
        require(
            msg.value >= _price,
            "Message value must be at least as much as the item price"
        );
        _;
    }
    ...
    modifier sold(uint256 _upc) {
        require(items[_upc].itemState == State.Sold, "Item needs to be sold");
        _;
    }
